...
// Options that (should where relevant) apply to all operating systems
    ...
    #define GFX_SHOW_COMPILER                        GFXON
...
#define GDISP_NEED_TIMERFLUSH                        GFXON
...
#define GDISP_NEED_TEXT                              GFXON
  #define GDISP_NEED_TEXT_WORDWRAP                 GFXON
   ...
   #define GDISP_INCLUDE_FONT_LARGENUMBERS          GFXON
    ...
    //#define GDISP_INCLUDE_FONT_DEJAVUSANSBOLD12_AA   GFXON
...
#define GDISP_NEED_IMAGE                             GFXON
    ...
    #define GDISP_NEED_IMAGE_PNG                     GFXON
        #define GDISP_NEED_IMAGE_PNG_INTERLACED      GFXON
        ...
        #define GDISP_NEED_IMAGE_PNG_PALETTE_124     GFXOFF
        #define GDISP_NEED_IMAGE_PNG_PALETTE_8       GFXOFF
        #define GDISP_NEED_IMAGE_PNG_GRAYSCALE_124   GFXOFF
        #define GDISP_NEED_IMAGE_PNG_GRAYSCALE_8     GFXOFF
        #define GDISP_NEED_IMAGE_PNG_GRAYSCALE_16    GFXOFF
        #define GDISP_NEED_IMAGE_PNG_GRAYALPHA_8     GFXOFF
        #define GDISP_NEED_IMAGE_PNG_GRAYALPHA_16    GFXOFF
        #define GDISP_NEED_IMAGE_PNG_RGB_8           GFXOFF
        #define GDISP_NEED_IMAGE_PNG_RGB_16          GFXOFF
        #define GDISP_NEED_IMAGE_PNG_RGBALPHA_8      GFXOFF
        #define GDISP_NEED_IMAGE_PNG_RGBALPHA_16     GFXOFF
    ...
    #define GDISP_NEED_IMAGE_ACCOUNTING              GFXON
...
#define GDISP_DRIVER_LIST                            GDISPVMT_Win32, GDISPVMT_Win32
        ...
        #define GDISP_HARDWARE_QUERY                 GFXON
        #define GDISP_HARDWARE_CLIP                  GFXON

        #define GDISP_PIXELFORMAT                    GDISP_PIXELFORMAT_RGB888
    #endif

#define GDISP_USE_GFXNET                             GFXON
    #define GDISP_GFXNET_PORT                        13001
    #define GDISP_GFXNET_CUSTOM_LWIP_STARTUP         GFXON
    #define GDISP_DONT_WAIT_FOR_NET_DISPLAY          GFXON
